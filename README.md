...
A web app for text analysis powered by the Groq API and LLaMA 3.3 70B. Works as a single HTML file — no server, no installation required. Supports **Slovak and English** UI.
...
- **SK/EN language toggle** — switch the entire UI between Slovak and English; preference saved to localStorage
